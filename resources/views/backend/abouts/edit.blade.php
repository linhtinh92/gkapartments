                            ...
                            <div class="panel panel-flat">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label>Title:</label>
                                        <input type="text" name="title" value="{{old('title',isset($about) ? $about->title : '')}}"
                                               class="form-control" placeholder="Title about" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Content:</label>
                                        <textarea class="form-control"
                                                  name="content" id="editor-full" rows="4" cols="4" >{{old('content',isset($about) ? $about->content : '')}}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label class="display-block">Status:</label>

                                        <label class="radio-inline">
                                            <input type="radio" name="status" class="styled" {{isset($about) && $about->status == 1 ? 'checked' : ''}}
                                                   value="1">
                                            Show
                                        </label>

                                        <label class="radio-inline">
                                            <input type="radio" name="status" class="styled" value="0" {{isset($about) && $about->status == 0 ? 'checked' : ''}}>
                                            Hide
                                        </label>
                                    </div>
