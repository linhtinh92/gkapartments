        ...
        <div class="page-header-content">
            <div class="page-title">
                ...
                <ul class="button-create">
                    <li><a href="{{route('admin.abouts.create')}}" class="btn btn-primary">Create about <i
                        ...
                        @foreach($abouts as $about)
                            <tr>
                                ...
                                <td class="text-center">
                                    <ul class="icons-list">
                                        <li>
                                            <a href="{{route('admin.abouts.edit',$about->id)}}" data-toggle="tooltip" data-original-title="Edit" title="Edit"> <i class="icon-pencil5"></i> </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)" onclick="confirmDelete('{{route('admin.abouts.destroy',$about->id)}}')" data-toggle="tooltip" data-original-title="Delete">
