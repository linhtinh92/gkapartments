        ...
        <div class="page-header-content">
            <div class="page-title">
                ...
                <ul class="breadcrumb breadcrumb-caret position-right">
                    ...
                    <li><a href="{{route('admin.brandLogos.index')}}">List brandLogos</a></li>
        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-md-12">
                        <!-- Basic legend -->
                        <form action="{{route('admin.brandLogos.update',$brandLogo->id)}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            ...
                            <div class="panel panel-flat">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label>Title:</label>
                                        <input type="text" name="title" value="{{old('title',isset($brandLogo) ? $brandLogo->title : '')}}"
                                               class="form-control" placeholder="Title brandLogo" required>
                                    </div>
                                    <div class="form-group">
                                            ...
                                            <div class="file-drop-disabled">
                                                <div class="file-preview-thumbnails">
                                                    ...
                                                    <div class="file-preview-frame" id="preview-1481647975231-0" data-fileindex="0">
                                                        <img src="{{url($brandLogo->images)}}" class="file-preview-image" style="width:auto;height:160px;">
                                                    </div>
                                                </div>
                                        ...
                                        <input type="hidden" name="temp_images" value="{{$brandLogo->images or ""}}">
                                    </div>
									<div class="form-group">
                                        <label>Link:</label>
                                        <input type="text" name="link" value="{{old('link',isset($brandLogo) ? $brandLogo->link : '')}}"
                                               class="form-control" placeholder="Link brandLogo">
                                    </div>
                                    <div class="form-group">
                                        <label class="display-block">Status:</label>

                                        <label class="radio-inline">
                                            <input type="radio" name="status" class="styled" {{isset($brandLogo) && $brandLogo->status == 1 ? 'checked' : ''}}
                                                   value="1">
                                            Show
                                        </label>

                                        <label class="radio-inline">
                                            <input type="radio" name="status" class="styled" value="0" {{isset($brandLogo) && $brandLogo->status == 0 ? 'checked' : ''}}>
                                            Hide
                                        </label>
                                    </div>
                                    <div class="text-right">
                                        <a href="{{route('admin.brandLogos.index')}}" style="float: left">
