        ...
        <div class="page-header-content">
            <div class="page-title">
                ...
                <ul class="button-create">
                    <li><a href="{{route('admin.roomTypes.create')}}" class="btn btn-primary">Create roomType <i
                        ...
                        @foreach($roomTypes as $roomType)
                            <tr>
                                ...
                                <td class="text-center">
                                    <ul class="icons-list">
                                        <li>
                                            <a href="{{route('admin.roomTypes.edit',$roomType->id)}}" data-toggle="tooltip" data-original-title="Edit" title="Edit"> <i class="icon-pencil5"></i> </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)" onclick="confirmDelete('{{route('admin.roomTypes.destroy',$roomType->id)}}')" data-toggle="tooltip" data-original-title="Delete">
