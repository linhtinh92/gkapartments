        ...
        <div class="page-header-content">
            <div class="page-title">
                ...
                <ul class="button-create">
                    <li><a href="{{route('admin.sliders.create')}}" class="btn btn-primary">Create slider <i
                    ...
                    <table class="table" id="myTable">
                        ...
                        @foreach($sliders as $slider)
                            <tr>
                                <td>{{$slider->title}}</td>
                                <td>
                                    <img src="{{url($slider->images)}}" width="100px">
                                </td>
                                ...
                                <td class="text-center">
                                    <ul class="icons-list">
                                        <li>
                                            <a href="{{route('admin.sliders.edit',$slider->id)}}" data-toggle="tooltip" data-original-title="Edit" title="Edit"> <i class="icon-pencil5"></i> </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)" onclick="confirmDelete('{{route('admin.sliders.destroy',$slider->id)}}')" data-toggle="tooltip" data-original-title="Delete">
