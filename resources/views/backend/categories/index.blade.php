        ...
        <div class="page-header-content">
            <div class="page-title">
                ...
                <ul class="button-create">
                    <li><a href="{{route('admin.categories.create')}}" class="btn btn-primary">Create categorie <i
                        ...
                        @foreach($categories as $categorie)
                            <tr>
                                ...
                                <td class="text-center">
                                    <ul class="icons-list">
                                        <li>
                                            <a href="{{route('admin.categories.edit',$categorie->id)}}" data-toggle="tooltip" data-original-title="Edit" title="Edit"> <i class="icon-pencil5"></i> </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)" onclick="confirmDelete('{{route('admin.categories.destroy',$categorie->id)}}')" data-toggle="tooltip" data-original-title="Delete">
