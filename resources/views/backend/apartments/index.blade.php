        ...
        <div class="page-header-content">
            <div class="page-title">
                ...
                <ul class="button-create">
                    <li><a href="{{route('admin.apartments.create')}}" class="btn btn-primary">Create apartment <i
                ...
                <div class="panel panel-flat">
                    ...
                    <table class="table" id="myTable">
                        ...
                        @foreach($apartments as $apartment)
                            <tr>
                                <td>{{$apartment->title or ""}}</td>
								<td>
                                    <img src="{{url($apartment->avatar)}}" width="100px">
                                </td>
                                <td>{{$apartment->sumary or ""}}</td>
                                <td>
                                ...
                                <td class="text-center">
                                    <ul class="icons-list">
                                        <li>
                                            <a href="{{route('admin.apartments.edit',$apartment->id)}}" data-toggle="tooltip" data-original-title="Edit" title="Edit"> <i class="icon-pencil5"></i> </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)" onclick="confirmDelete('{{route('admin.apartments.destroy',$apartment->id)}}')" data-toggle="tooltip" data-original-title="Delete">
