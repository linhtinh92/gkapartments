        ...
        <div class="page-header-content">
            <div class="page-title">
                ...
                <ul class="button-create">
                    <li><a href="{{route('admin.users.create')}}" class="btn btn-primary">Create User <i
                    ...
                    <table class="table" id="myTable">
                        ...
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td>{{$user->username}}</td>
                                <td>
                                    <img src="{{url($user->avatar)}}" width="100px">
                                </td>
                                <td>
                                    @if($user->status == 1)
                                ...
                                <td class="text-center">
                                    <ul class="icons-list">
                                        <li>
                                            <a href="{{route('admin.users.edit',$user->id)}}" data-toggle="tooltip" data-original-title="Edit" title="Edit"> <i class="icon-pencil5"></i> </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)" onclick="confirmDelete('{{route('admin.users.destroy',$user->id)}}')" data-toggle="tooltip" data-original-title="Delete">
