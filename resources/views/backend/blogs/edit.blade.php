        ...
        <div class="page-header-content">
            <div class="page-title">
                ...
                <ul class="breadcrumb breadcrumb-caret position-right">
                    ...
                    <li><a href="{{route('admin.blogs.index')}}">List Blogs</a></li>
                            ...
                            <div class="panel panel-flat">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label>Title:</label>
                                        <input type="text" name="title" value="{{old('title',isset($blog) ? $blog->title : '')}}"
                                               class="form-control" placeholder="Title blog" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Description:</label>
										<textarea class="form-control" name="description" >{{old('description',isset($blog) ? $blog->description : '')}}</textarea>
                                    </div>
                                    <div class="form-group">
                                            ...
                                            <div class="file-drop-disabled">
                                                <div class="file-preview-thumbnails">
                                                    ...
                                                    <div class="file-preview-frame" id="preview-1481647975231-0" data-fileindex="0">
                                                        <img src="{{url($blog->images)}}" class="file-preview-image" style="width:auto;height:160px;">
                                                    </div>
                                                </div>
                                        ...
                                        <input type="hidden" name="temp_images" value="{{$blog->images or ""}}">
                                    </div>
									<div class="form-group">
                                        <label>Link:</label>
                                        <input type="text" name="link" value="{{old('link',isset($blog) ? $blog->link : '')}}"
                                               class="form-control" placeholder="Link blog">
                                    </div>
                                    <div class="form-group">
                                        <label class="display-block">Status:</label>

                                        <label class="radio-inline">
                                            <input type="radio" name="status" class="styled" {{isset($blog) && $blog->status == 1 ? 'checked' : ''}}
                                                   value="1">
                                            Show
                                        </label>

                                        <label class="radio-inline">
                                            <input type="radio" name="status" class="styled" value="0" {{isset($blog) && $blog->status == 0 ? 'checked' : ''}}>
                                            Hide
                                        </label>
                                    </div>
                                    <div class="text-right">
                                        <a href="{{route('admin.blogs.index')}}" style="float: left">
