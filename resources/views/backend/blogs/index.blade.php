        ...
        <div class="page-header-content">
            <div class="page-title">
                ...
                <ul class="button-create">
                    <li><a href="{{route('admin.blogs.create')}}" class="btn btn-primary">Create Blog <i
                    ...
                    <table class="table" id="myTable">
                        ...
                        @foreach($blogs as $blog)
                            <tr>
                                <td>{{$blog->title}}</td>
                                <td>
                                    <img src="{{url($blog->images)}}" width="100px">
                                </td>
                                ...
                                <td class="text-center">
                                    <ul class="icons-list">
                                        <li>
                                            <a href="{{route('admin.blogs.edit',$blog->id)}}" data-toggle="tooltip" data-original-title="Edit" title="Edit"> <i class="icon-pencil5"></i> </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)" onclick="confirmDelete('{{route('admin.blogs.destroy',$blog->id)}}')" data-toggle="tooltip" data-original-title="Delete">
