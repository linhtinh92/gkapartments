            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a class="current" href="{{route('web.category',$category->slug)}}"
                                        ...
                                        <div class="sort-by an-short">
                                            <div class="shop6">
                                                ...
                                                <select id="input-sort" onchange="location = this.value;">
                                                    <option value="{{route('web.category',$category->slug)}}">Default
                                                    </option>
                                                    <option value="{{route('web.category',$category->slug)}}?sort=name&order=ASC" {{$default_sort == "name" && $default_order == "ASC" ? 'selected' :''}}>
                                                        Tên (A - Z)
                                                    </option>
                                                    <option value="{{route('web.category',$category->slug)}}?sort=name&order=DESC" {{$default_sort == "name" && $default_order == "DESC" ? 'selected' :''}}>
                                                        Tên (Z - A)
                                                    </option>
                                                    <option value="{{route('web.category',$category->slug)}}?sort=price&order=ASC" {{$default_sort == "price" && $default_order == "ASC" ? 'selected' :''}}>
                                                        Giá (Thấp &gt; Cao)
                                                    </option>
                                                    <option value="{{route('web.category',$category->slug)}}?sort=price&order=DESC" {{$default_sort == "price" && $default_order == "DESC" ? 'selected' :''}}>
                                                        Giá (Cao &gt; Thấp)
                                                    </option>
                                                </select>
                                            </div>
